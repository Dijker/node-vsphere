...
function getPropertySpecArray(typeArray, propertyArray) {
    var propertySpecArray = [];
    //Handle arrays of object types
    ...
    _.forEach(typeArray, function(type) {
        ...
        propertySpecArray.push(propertySpec);
    })
...
Client.prototype.getMORefsInContainerByTypeName = function(MORefFolder, type, nameArray) {
    ...
    this.getMORefsInContainerByTypePropertyArray(MORefFolder, type, 'name')
        .once('result', function(result) {
            ...
            //vsphere 6.5 - a single object OR an array can be returned. Ensure all returned objects are handled.
            if (!Array.isArray(allObjsArray)) {
...
Client.prototype.getMORefsInContainerByTypePropertyArray = function(MORefFolder, type, propertyArray) {
    ...
    this.vc.runCommand('CreateContainerView', {
            _this: viewManager,
        ...
        .once('result', function(result) {
            ...
            var propertyFilterSpec = {
                ...
                propSet: getPropertySpecArray(type, propertyArray),
            ...
            self.vc.runCommand('RetrievePropertiesEx', {
...
Client.prototype.waitForValues = function(MORef, filterProps, endWaitProps, expectedVals) {
    ...
    singletonClient.once('ready', function() {
            ...
            singletonClient.runCommand('CreateFilter', {
                    _this: singletonClient.serviceContent.propertyCollector,
                ...
                .once('result', function(result) {
                    ...
                    (function waitForUpdates() {
                        ...
                        singletonClient.runCommand('WaitForUpdatesEx', {
                                _this: singletonClient.serviceContent.propertyCollector,
                                version: version,
                                options: {}
                            })
